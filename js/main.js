...
function generate()
{
  ...
  localStorage.html = document.getElementById('HTMLeditor').value;
  localStorage.css = document.getElementById('CSSeditor').value;
}

function loadEditors() {
  HTMLeditor.getDoc().setValue(localStorage.html);
  CSSeditor.getDoc().setValue(localStorage.css);
}
